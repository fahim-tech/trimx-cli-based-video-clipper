...
impl InspectInteractor {
    ...
    pub async fn inspect_file(
    ...
    ) -> Result<InspectResponse, DomainError> {
        ...
        self.log_port
            .info(&format!(
                "Starting media file inspection for: {}",
                input_file
            ))
            .await;
        ...
        self.log_port
            .info(&format!(
                "Media file probed successfully: {} streams",
        ...
        // Log completion
        self.log_port
            .info("Media file inspection completed successfully")
            .await;
    ...
    fn format_as_text(
        ...
        output.push_str("Media File Information:\n");
