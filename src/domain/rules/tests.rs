...
mod tests {
    ...
    fn create_test_media_info() -> MediaInfo {
        ...
        let audio_stream =
            AudioStreamInfo::new(1, "aac".to_string(), 48000, 2, Timebase::av_time_base()).unwrap();
    ...
    fn test_clipping_mode_selector_auto_copy() {
        ...
        let mode =
            ClippingModeSelector::select_mode(&media_info, &cut_range, ClippingMode::Auto).unwrap();
    ...
    fn test_clipping_mode_selector_force_reencode() {
        ...
        let mode =
            ClippingModeSelector::select_mode(&media_info, &cut_range, ClippingMode::Reencode)
                .unwrap();
    ...
    fn test_stream_copy_support_audio() {
        let aac_stream =
            AudioStreamInfo::new(0, "aac".to_string(), 48000, 2, Timebase::av_time_base()).unwrap();
