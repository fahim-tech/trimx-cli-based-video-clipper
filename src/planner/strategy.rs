...
impl StrategyPlanner {
    ...
    fn analyze_keyframes(&self, input_path: &str, start_time: f64, end_time: f64) -> TrimXResult<KeyframeInfo> {
        ...
        let next_keyframe = gop_analysis.keyframes.iter()
    ...
    fn find_nearest_keyframe(&self, analysis: &GOPAnalysis, target_time: f64, prefer_earlier: bool) -> Option<f64> {
    ...
    fn can_use_copy_mode(&self, keyframe_info: &KeyframeInfo, original_start_time: f64, original_end_time: f64) -> bool {
        ...
        if let (Some(start_keyframe), Some(end_keyframe)) = (keyframe_info.start_keyframe, keyframe_info.end_keyframe) {
